...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // TODO auto login to be deleted
        mEmailView.setText("admin");
        mPasswordView.setText("admin");
        //Intent intent = new Intent(mMainActivity, MainMenuActivity.class);
    ...
    private void attemptLogin()
    {
        ...
        else
        {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, mMainActivity);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        UserLoginTask(String email, String password, Activity mainActivity)
        {
            mEmail = email;
            mPassword = password;
        ...
        protected void onPostExecute(final Boolean success)
        {
            ...
            if (success)
            {
                System.out.println("On post execute invoked...");
